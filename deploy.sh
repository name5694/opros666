...
DOMAIN_NAME="oprosru.ru" # необходимо заменить
EMAIL="somemail@mail.ru" # необходимо заменить

# Переменные для скриптов
REPO_URL="https://github.com/name5694/opros666.git" # необходимо заменить
APP_DIR=~/myapp
